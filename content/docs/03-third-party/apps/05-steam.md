...
- **Поддержка современных стандартов**: Steam полностью совместим с ROSA Linux и поддерживает современные протоколы безопасности.
- **Интеграция с системой**: Приложение интегрируется с системой уведомлений и другими компонентами рабочего окружения.
- **Поддержка glibc 2.40**: Благодаря новой версии glibc, Steam стабильно работает в ROSA Linux.
- **Поддержка Wayland**: В ROSA Fresh 13 с KDE Plasma 6 Steam поддерживает сеансы Wayland.
- **Поддержка современных технологий**: Благодаря ядру 6.12 LTS и systemd 256, Steam стабильно работает с современными технологиями.
- **Автоустановка драйверов для видеокарт NVIDIA**: При наличии поддерживаемой видеокарты драйвера устанавливаются автоматически, что улучшает производительность игр.
