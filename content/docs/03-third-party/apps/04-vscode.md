...
- **Поддержка современных стандартов**: VS Code полностью совместим с ROSA Linux и поддерживает современные протоколы безопасности.
- **Интеграция с системой**: Приложение интегрируется с системой уведомлений и другими компонентами рабочего окружения.
- **Поддержка glibc 2.40**: Благодаря новой версии glibc, VS Code стабильно работает в ROSA Linux.
- **Поддержка Wayland**: В ROSA Fresh 13 с KDE Plasma 6 VS Code поддерживает сеансы Wayland.
- **Поддержка современных технологий**: Благодаря ядру 6.12 LTS и systemd 256, VS Code стабильно работает с современными технологиями.
