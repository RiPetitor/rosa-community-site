...
После освоения SPEC-файла переходите к **[Модулю 3: Сборочное окружение](@/community/packaging-school/03-build-environment/_index.md)** — там мы настроим рабочее место и соберём первый пакет.
