...
1. **[rpmlint: все проверки с объяснениями](rpmlint.md)**  
   Что проверяет rpmlint, как исправлять ошибки и предупреждения.

2. **[Тестирование пакета](testing.md)**  
   Как проверить, что пакет работает корректно.

3. **[Чеклист перед релизом](checklist.md)**  
   Что проверить перед публикацией в репозиторий.

4. **[Сопровождение пакета](maintenance.md)**  
...
После теории переходите к **[Практикумам](@/community/packaging-school/practice/_index.md)** — пошаговые разборы упаковки реальных проектов.
