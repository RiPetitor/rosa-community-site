...
1. **[Что такое пакет и зачем он нужен](@/community/beginner/01-concepts/what-is-package.md)**  
   Проблемы «ручной» установки, преимущества пакетной системы, роль сборщика.

2. **[Внутреннее устройство RPM](@/community/beginner/01-concepts/rpm-structure.md)**  
   Из чего состоит RPM-файл: метаданные, payload, подписи.

3. **[Репозитории и пакетные менеджеры](@/community/beginner/01-concepts/repositories.md)**  
   Как dnf/urpmi работают с репозиториями, разрешение зависимостей.

4. **[Стандарт FHS и пути установки](@/community/beginner/01-concepts/fhs-standards.md)**  
...
После освоения основ переходите к **[Модулю 2: Анатомия SPEC-файла](@/community/beginner/02-spec-file/_index.md)** — там мы детально разберём «рецепт» пакета.
