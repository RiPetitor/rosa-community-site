...
1. **[Установка инструментов](@/community/beginner/03-build-environment/tools-setup.md)**  
   Какие пакеты нужны для сборки, настройка окружения.

2. **[Структура ~/rpmbuild](@/community/beginner/03-build-environment/rpmbuild-tree.md)**  
   Каталоги BUILD, RPMS, SOURCES, SPECS, SRPMS и их назначение.

3. **[Первая сборка: GNU Hello](@/community/beginner/03-build-environment/first-build.md)**  
   Пошаговая сборка простого пакета от скачивания исходников до установки.

4. **[Что такое buildroot](@/community/beginner/03-build-environment/buildroot.md)**  
   Временный корень файловой системы, изоляция сборки.

5. **[Типичные ошибки и их решение](@/community/beginner/03-build-environment/common-errors.md)**  
...
После освоения локальной сборки переходите к **[Модулю 4: Системы сборки](@/community/intermediate/04-build-systems/_index.md)** — там мы разберём особенности Autotools, CMake, Meson, Python, Rust и Go.
